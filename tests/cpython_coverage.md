...
| `invalid_case_block` | supported | Missing case colons, missing case indentation with and without guards, and missing case patterns are rejected by `cpython_invalid_match_pattern_subset` |
