...
- `cpython_runtime_exception_capture_subset`, backed by
  ...
  catchable binary bit-and `TypeError` behavior, catchable in-place add
  `TypeError` behavior,
