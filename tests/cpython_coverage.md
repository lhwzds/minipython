...
| `invalid_kvpair_unpacking` | supported | Invalid starred/double-starred dictionary keys and values, and unparenthesized conditional dict unpacking forms with CPython-style `invalid syntax` are rejected by `cpython_invalid_dict_display_syntax_subset` |
