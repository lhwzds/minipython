...
- The bundled `collections` module also includes
  ...
  descriptor access through the class and instance, including method-wrapper
  `__get__` error paths.
- The bundled `collections` module also includes
