...
| `invalid_starred_expression_unpacking_sequence` | supported | leading list double-star unpacking forms with CPython-style `invalid syntax`, dict unpacking in starred expression sequences, and nested invalid starred unpacking are rejected by `cpython_invalid_starred_expression_subset` |
