...
- Added `cpython_str_instance_doc_attribute_subset` and
  ...
  matching `str.__doc__` and `dir(value)` without promoting bytearray instance `__doc__` attributes.
