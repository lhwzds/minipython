...
- Added `cpython_math_integer_alias_diff_subset` as capability-gated direct
  ...
  oracles that lack the submodule continue to use the local subset evidence.
