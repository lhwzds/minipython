...
- Added `cpython_float_hash_and_sys_info_subset`, adapted from CPython
  ...
  and `sys.flags.dont_write_bytecode` as integer `0`; MiniPython still does not
  write bytecode cache files in the sandbox.
