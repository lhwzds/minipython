...
- Added `cpython_collections_namedtuple_new_builtins_globals_diff_subset` and
  ...
  `__new__.__globals__['__builtins__'] == {}` public behavior. The broader
  `function.__builtins__` attribute assertion remains covered by the local
  subset-only `cpython_collections_namedtuple_new_builtins_issue_43102_subset`.
