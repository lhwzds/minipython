...
- Added `cpython_json_function_bound_method_defaults_metadata_subset` and
  ...
  `__getattribute__('__defaults__')` lookup, without adding bound method
  `__globals__`.
- Added `cpython_json_function_bound_method_kwdefaults_metadata_subset` and
  ...
  `__getattribute__('__kwdefaults__')` lookup, without adding bound method
  `__globals__`.
- Added `cpython_json_function_bound_method_annotations_metadata_subset` and
  ...
  `__getattribute__('__annotations__')` lookup, without adding bound method
  `__globals__`.
- Added `cpython_json_function_bound_method_dict_metadata_subset` and
  ...
  `__getattribute__('__dict__')` lookup, without adding bound method
  `__globals__`.
