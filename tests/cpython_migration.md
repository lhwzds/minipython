...
- Migrated first-pass attribute-introspection builtin coverage from
  ...
  contract. Ordinary `str()` conversion now separately dispatches class-level
  `__str__` for `str()`, `print()`, f-string `!s`,
