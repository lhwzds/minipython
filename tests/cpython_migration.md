...
- Added `cpython_copy_function_module_metadata_subset` and
  `cpython_copy_function_module_metadata_diff_subset`, covering copy public function
  `__module__` metadata (`copy.copy.__module__`, `copy.deepcopy.__module__`, and
