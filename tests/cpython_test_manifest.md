...
| `test_type_typeparams` | `ported` | `cpython_type_typeparams_subset` covers generic class `__type_params__`, `typing.TypeVar` identity, user assignment override, delete rejection, and preserving the override. `cpython_type_parameters_missing_for_nongeneric_subset` and `cpython_type_parameters_missing_for_nongeneric_diff_subset` cover ordinary class `__parameters__` absence while preserving generic class `__parameters__`. | None for this method. |
