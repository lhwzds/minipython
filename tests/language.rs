...
fn sys_sandbox_subset_keeps_export_surface_explicit() {
    assert_eq!(
        ...
        Ok(output_lines(&[
            ...
            "SimpleNamespace 0 0 False 0 0 0 0 0 0",
