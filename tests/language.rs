...
fn sys_sandbox_subset_keeps_export_surface_explicit() {
    assert_eq!(
        ...
        Ok(output_lines(&[
            ...
            "__all__ False",
            "__file__ False",
            "['__breakpointhook__', '__name__', '__package__', '_getframe', 'argv', 'breakpointhook', 'builtin_module_names', 'byteorder', 'dont_write_bytecode', 'exc_info', 'flags', 'float_info', 'float_repr_style', 'get_int_max_str_digits', 'getdefaultencoding', 'hash_info', 'hexversion', 'implementation', 'is_finalizing', 'maxsize', 'modules', 'path', 'set_int_max_str_digits', 'stderr', 'stdin', 'stdout', 'version', 'version_info', 'warnoptions']",
            "list []",
            "list ['']",
            "list True",
            "bool False",
