...
impl Compiler {
    ...
    fn compile_augmented_binary_instruction(
        ...
        match op {
            ...
            BinaryOp::TrueDivide => {
                self.instructions
                    .push(Instruction::InPlaceTrueDivide { dst, left, right });
            }
            BinaryOp::FloorDivide => {
                self.instructions
            ...
            BinaryOp::Power => {
                self.instructions
                    .push(Instruction::InPlacePower { dst, left, right });
            }
            BinaryOp::BitOr => {
                self.instructions
...
mod tests {
    ...
    #[test]
    fn compiles_true_divide_augmented_assignment_to_in_place_bytecode() {
        let program = Program {
            statements: vec![Stmt::AugAssign {
                target: Target::Name("x".to_string()),
                op: BinaryOp::TrueDivide,
                value: Expr::Number(3),
            }],
        };
    ...
    #[test]
    fn compiles_power_augmented_assignment_to_in_place_bytecode() {
        let program = Program {
            statements: vec![Stmt::AugAssign {
                target: Target::Name("x".to_string()),
                op: BinaryOp::Power,
    ...
    #[test]
    fn compiles_left_shift_augmented_assignment_to_in_place_bytecode() {
        let program = Program {
            statements: vec![Stmt::AugAssign {
                target: Target::Name("x".to_string()),
